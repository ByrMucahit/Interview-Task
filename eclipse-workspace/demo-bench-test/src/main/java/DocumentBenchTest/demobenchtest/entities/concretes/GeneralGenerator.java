...
public class GeneralGenerator {
	...
	public GeneralGenerator(Timestamp timeStamp, int idStamp, String msg_status, String msg_generation,
			String message_type, String serial_number, String new_serial_number, String old_serial_number,
			String message_identifier, String category, String list_of_TAIs, String warning_area_list,
			String repetition_period, String extended_repetition_period, String number_of_broadcasts_requested,
			String broadcast_message_content, String warning_security_information, String data_coding_scheme,
			String warning_message_content, String omc_id, String concurrent_warning_message_indicator,
			String send_write_replace_warning_indication, String global_enb_id, String send_stop_warning_indication,
			String stop_all_indicator, String paging_etws_indicator, String message_structure, String warning_type,
			String broadcast_message_content_validity_indicator, String emergency_indicator, String channel_indicator,
			String number_of_pages, String schedule_period, String number_of_reserved_slots,
			String broadcast_message_type, String warning_period, String length_indicator,
			String keep_alive_repetition_period, Integer cause, String criticality_diagnostics,
			String broadcast_scheduled_area_list, String broadcast_cancelled_area_list,
			String broadcast_empty_area_list, Integer restarted_cell_list, String list_of_TAIs_restart,
			String list_of_EAIs_restart, String failed_cell_list, String failure_list,
			String number_of_broadcasts_completed_list, String radio_resource_loading_list, String recovery_indication,
			String service_areas_list, String typeoferror, String cell_list, String extras,
			String unknown_tracking_area_list, String messagetype_response, String ip_address,
			Short is_broadcast_started, short is_draft, short is_deletee, int sender_id, int department_id,
			String subject, int language, String selected_map_areas, Timestamp start_time, Timestamp end_time,
			String status, String updated_map_areas, String killed_map_areas, String status_map_areas, Integer counter,
			Short is_abnormal_message, String selected_cells) {
		super();
